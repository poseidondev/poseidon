...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Poseidon " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"192.243.103.201", "192.243.103.201"},
    {"35.202.169.170", "35.202.169.170"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Poseidon is probably already running."), addrBind.ToString().c_str());
        else
